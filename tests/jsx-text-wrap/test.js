// Wrapping text
x = <div>Some text that would need to wrap on to a new line in
    order to display correctly and nicely < /div>

/ / Wrapping tags
x = <div><first>f</first> <first>f</first><first>f</first> <first>f</first>
    <first>f</first> <first>f</first>< /div>
...
/ / Wrapping tags
x = <div><a /><b /><c /><first>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<
        /first> <first>f</first>< /div>
...
function DiffOverview(props) {
  ...
  return (
      <div><div className = "alert alert-info"><p>This diff overview is computed
              against the current list of records in
          this collection and the list it contained on<b>{
              humanDate(since)}</b>.
        </p><p>
          <b>Note: </b> <code>last_modified</code>and<code>schema<
...
x = <font size={-3}><i>Starting at minute {graphActivity.startTime}, running for {graphActivity.length} to minute {graphActivity.startTime + graphActivity.length}</i>
          </font>
    ...
    <div>
      First
              ...
              Third</div>
                  ...
                  x = <div>First<div>Second</div> Third
  </div>

          leading_whitespace = <div>First Second Third Fourth Fifth Sixth
...
trailing_whitespace =
  <div>First Second Third Fourth Fifth Sixth Seventh Eighth Ninth Tenth Eleventh Twelfth Thirteenth Fourteenth </div>
                  ...
                  no_leading_or_trailing_whitespace = <
                      div>First Second Third Fourth Fifth Sixth Seventh Eighth
  ...
  <div>
    <span>
      ...
      (<span>Second</span>)
           ...
           x = <div><span>First second third fourth fifth sixth
               seventh</span>,
    (<span>
      Second
    </span>) <
...
this_really_should_split_across_lines =
  <div>
    before{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after{stuff}after
          ...
          unstable_before = <div className = "yourScore">Your score:
      ...
      solitary_whitespace =
          <div first = "first" second = "second" third = "third" fourth =
...
jsx_around_multiline_element =
  <div>Before <div>{"Enough text to make this element wrap on to multiple lines when formatting"}</div>
          After<
              /div>
...
convert_space_expressions =
  <div>{" "}</div>
              ...
              x = <div><first /><second /><third /><fourth /><fifth /><sixth />
      </div>
...
no_text_one_tag_per_line = <div><first /><second />
    </div>
...
line_after_br_2 = <div>A<br />B<br />
        C</div>

br_followed_by_whitespace = <div><br />text<
            /div>
...
dont_preserve_blank_lines_when_jsx_contains_text =
  <div>
    ...
    Second
        ...
        multiple_expressions = <div>{header} {body} {footer}<
            /div>

single_expression_child_tags =
  <div>
    You currently have <strong>{dashboardStr}</strong>
            and<strong>{userStr}</strong>
  </div>

                expression_does_not_break =
                    <div>texty text text text text text text text text text text
                        text{this.props.type} < /div>

/ / FIXME
br_triggers_expression_break = <div><
    br />text text text text text text text text text text text{this.props
                                                                    .type}<
    /div>
...
/ / Don't break a self-closing element without attributes
                    ...
                    <p>text text text text text text text text text text text
                        text text text text<br />text text text text text text<
                            /p>;
  ...
  <div>
    <div>First</div>-
                        <div>Second</div>
                            ...
                            x =
                            <div><div className = "first" tabIndex = "1">First<
                                /div>-
      ...
      First
                            ...
                            <div className = "second" tabIndex = "2">
                                Second</div>
                                    ...
                                    x = <div>
    <div className = "first" tabIndex = "1">
        First</div>-<div className="second" tabIndex="2">Second</div>
    </div>
...
x =
  <div>
    ...
    {second}
            ...
            x = <div><strong>text here</strong>.<br />
    </div>
