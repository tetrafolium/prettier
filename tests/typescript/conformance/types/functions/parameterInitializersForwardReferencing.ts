...
function inside(a = b) { var b; }

function outside() {
  var b;
  function inside(
      a = b) { // Still an error because b is declared inside the function
    var b;
  }
}
...
// Should not produce errors - can reference later parameters if they occur
// within a function expression initializer.
