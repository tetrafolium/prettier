...
// U has a string index signature of a union type of the types of the string
// index signatures from each type in U.
...
// U has a numeric index signature of a union type of the types of the numeric
// index signatures from each type in U.
