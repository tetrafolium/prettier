...
// If each type in U has call signatures and the sets of call signatures are
// identical ignoring return types, U has the same set of call signatures, but
// with return types that are unions of the return types of the respective call
// signatures from each type in U.
...
var unionOfDifferentReturnType1: {(a: number): number; (a: string) : string;}|{
  (a: number): Date;
  (a: string): boolean;
};
...
var unionOfDifferentParameterTypes: {(a: number): number;}|{
  (a: string): Date;
};
...
var unionOfDifferentNumberOfSignatures: {(a: number): number;}|{
  (a: number): Date;
  (a: string): boolean;
};
...
var unionWithDifferentParameterCount: {(a: string): string;}|{
...
var unionWithOptionalParameter1: {(a: string, b?: number): string;}|{
  (a: string, b?: number): number;
};
strOrNum = unionWithOptionalParameter1('hello');
strOrNum = unionWithOptionalParameter1('hello', 10);
strOrNum =
    unionWithOptionalParameter1('hello', "hello"); // error in parameter type
strOrNum = unionWithOptionalParameter1();          // error

var unionWithOptionalParameter2: {(a: string, b?: number): string;}|
    {(a: string, b: number) : number};
...
strOrNum =
    unionWithOptionalParameter2('hello', "hello"); // error no call signature
strOrNum = unionWithOptionalParameter2();          // error no call signature

var unionWithOptionalParameter3: {(a: string, b?: number): string;}|{
  (a: string): number;
};
strOrNum = unionWithOptionalParameter3('hello');
strOrNum = unionWithOptionalParameter3('hello', 10); // error no call signature
strOrNum =
    unionWithOptionalParameter3('hello', "hello"); // error no call signature
strOrNum = unionWithOptionalParameter3();          // error no call signature

var unionWithRestParameter1: {(a: string, ...b: number[]): string;}|
    {(a: string, ...b: number[]) : number};
...
var unionWithRestParameter2: {(a: string, ...b: number[]): string;}|
    {(a: string, b: number) : number};
...
var unionWithRestParameter3: {(a: string, ...b: number[]): string;}|
    {(a: string) : number};
...
var unionWithRestParameter4: {(...a: string[]): string;}|{
  (a: string, b: string): number;
};
strOrNum = unionWithRestParameter4(
    "hello"); // error supplied parameters do not match any call signature
