...
fun('hi', ...iterableOf123); // No error - ignore the fact iterableOf123 could
                             // be empty

function funWithRestArray(x: 'hi', y: 123, ...rest: Array<number>) {}

funWithRestArray('hi', 123, ...iterableOf123); // Ok
funWithRestArray('hi', ...iterableOf123);      // No error - ignore the fact
                                               // iterableOf123 could be empty
funWithRestArray('hi', ...iterableOf123,
                 ...iterableOf123); // No error - ignore the fact iterableOf123
                                    // could be empty
