...
class Base {
  ...
  base_annotatedInitializedFieldInvalid: number =
  ...
  static base_annotatedInitializedFieldInvalid: number =
      'asdf'; // Error: string ~> number
...
class Child extends Base {
  ...
  child_annotatedInitializedFieldInvalid: number =
      'asdf'; // Error: string ~> number
  ...
  static child_annotatedInitializedFieldInvalid: number =
      'asdf'; // Error: string ~> number
...
(Child.child_annotatedInitializedFieldValid:
...
(Child.base_annotatedInitializedFieldInvalid:
...
(Child.child_annotatedInitializedFieldInvalid:
     string); // Error: number ~> string
