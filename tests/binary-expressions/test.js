...
const x = longVariable + longVariable + longVariable + longVariable -
...
const x = firstItemWithAVeryLongNameThatKeepsGoing ||
          firstItemWithAVeryLongNameThatKeepsGoing || [];
const x = call(firstItemWithAVeryLongNameThatKeepsGoing,
               firstItemWithAVeryLongNameThatKeepsGoing) ||
          [];
...
foo(obj.property * new Class() && obj instanceof Class && longVariable
        ? number + 5
        : false);
