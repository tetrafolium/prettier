 ...
 *     // treated as taking any string as argument, and `--option <${type}>`
 * will
 ...
 *     // be treated as `redirect` instead, or if you'd like to add description
 * for
 *     // the choice.
 *     choices?: Array<
 *       | string
 *       | { value: string, description?: string, deprecated?: boolean,
 * redirect?: string }
 *     >;
 *
...
const options = {
  ...
  "debug-benchmark" : {
    // Run the formatting benchmarks. Requires 'benchmark' module to be
    // installed.
    type : "boolean",
  },
  "debug-check" : {
    // Run the formatting once again on the formatted output, throw if
    // different.
    type : "boolean",
  },
  "debug-print-doc" : {
