...
/**
 * @typedef {{ ignorePath?: string, withNodeModules?: boolean, plugins: object
 * }} FileInfoOptions
 ...
 * automatically done internally by the method wrapper. See withPlugins() in
 * index.js.
 */
...
function normalizeFilePath(filePath, ignorePath) {
  return ignorePath ? path.relative(path.dirname(ignorePath), filePath)
                    : filePath;
}
