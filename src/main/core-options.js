 ...
 * @typedef {OptionValue | [{ value: OptionValue[] }] | Array<{ since: string,
 * value: OptionValue}>} OptionValueInfo
 *
 ...
 * @property {boolean | string} value - boolean for the option that is
 * originally boolean type
 * @property {string} description
 * @property {string} [since] - undefined if available since the first version
 * of the option
 * @property {string} [deprecated] - deprecated since version
