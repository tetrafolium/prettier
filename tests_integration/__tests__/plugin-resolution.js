...
describe(
    "automatically loads 'prettier-plugin-*' from --plugin-search-dir (same as autoload dir)",
    () => {
...
describe(
    "automatically loads '@<name>/prettier-plugin-*' from --plugin-search-dir (same as autoload dir)",
    () => {
      runPrettier("plugins/automatic", [
        "file.txt",
        "--parser=foobar",
...
describe(
    "automatically loads 'prettier-plugin-*' from --plugin-search-dir (different to autoload dir)",
    () => {
      runPrettier("plugins", [
        "automatic/file.txt",
        "--parser=foo",
...
describe(
    "does not crash when --plugin-search-dir does not contain node_modules",
    () => {
...
describe(
    "loads --plugin by relative path to its directory (assuming index.js)",
    () => {
      runPrettier("plugins", [
        "automatic/file.txt",
        "--parser=bar",
...
describe(
    "loads --plugin by relative path to its directory without leading ./ (assuming index.js)",
    () => {
      runPrettier("plugins", [
        "automatic/file.txt",
        "--parser=bar",
...
describe(
    "loads --plugin by filename without leading ./ and ext, should resolve to file, not package",
    () => {
      runPrettier("plugins/automatic", [
        "file.txt",
        "--parser=bar",
...
describe(
    "loads --plugin by bespoke plugin name (assuming it is installed in cwd)",
    () => {
