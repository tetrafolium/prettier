export default function(parser) {
  ...
  case "css":
    // Excerpted from the Bootstrap source, which is licensed under the MIT
    // license: https://github.com/twbs/bootstrap/blob/v4.0.0-beta.3/LICENSE
    return [
  ...
  case "json5":
  case "json-stringify":
    // Excerpted & adapted from Wikipedia, under the Creative Commons
    // Attribution-ShareAlike License https://en.wikipedia.org/wiki/JSON#Example
    return [
  ...
  case "mdx":
    // modified from
    // https://github.com/mdx-js/mdx/blob/master/packages/mdx/test/fixtures/blog-post.md
    return [
